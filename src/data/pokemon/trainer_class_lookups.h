...
const u16 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LEADER_ROXANNE] = TRAINER_CLASS_GUARDIAN,
    [FACILITY_CLASS_LEADER_BRAWLY] = TRAINER_CLASS_GUARDIAN,
    [FACILITY_CLASS_LEADER_TATE_AND_LIZA] = TRAINER_CLASS_GUARDIAN,
